...
Item {
    ...
    ListModel {
        id:first
        ListElement { letter: "q"; firstSymbol: "1"; keycode: Qt.Key_Q; symbolKeycode: Qt.Key_1}
        ListElement { letter: "w"; firstSymbol: "2"; keycode: Qt.Key_W; symbolKeycode: Qt.Key_2}
        ...
        ListElement { letter: "p"; firstSymbol: "0"; keycode: Qt.Key_E; symbolKeycode: Qt.Key_0}
    }
    ListModel {
        id:second
        ListElement { letter: "a"; firstSymbol: "!"; keycode: Qt.Key_A; symbolKeycode: Qt.Key_Exclam}
        ListElement { letter: "s"; firstSymbol: "@"; keycode: Qt.Key_S; symbolKeycode: Qt.Key_At}
        ...
        ListElement { letter: "l"; firstSymbol: "/"; keycode: Qt.Key_L; symbolKeycode: Qt.Key_Slash}
    }
    ListModel {
        id:third
        ListElement { letter: "z"; firstSymbol: "_"; keycode: Qt.Key_Z; symbolKeycode: Qt.Key_Underscore}
        ...
        ListElement { letter: "n"; firstSymbol: "-"; keycode: Qt.Key_N; symbolKeycode: Qt.Key_Minus}
        ListElement { letter: "m"; firstSymbol: "+"; keycode: Qt.Key_M; symbolKeycode: Qt.Key_Plus}
    }
}
